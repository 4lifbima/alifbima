...
const WORDS = ["Informatics Engineering Student", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind","Laravel"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/4lifbima" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/alif-bima-pradana-47b642334/" },
  { icon: Instagram, link: "https://www.instagram.com/alifbimapradana07" }
];
