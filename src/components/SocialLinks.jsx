...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://id.linkedin.com/in/alif-bima-pradana-47b642334",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Alif Pratama",
    icon: Facebook,
    url: "https://web.facebook.com/profile.php?id=100046320180299",
    color: "#03c2fc",
    gradient: "from-[#0362fc] to-[#03c2fc]"
  },
  {
    name: "GitHub",
    displayName: "Github",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@alifbima_",
    color: "black",
