...
export const portfolios: Portfolio[] = [
  ...
  {
    id: '9',
    slug: 'portal-data-sekolah-indonesia',
    title: 'Portal Data Sekolah Indonesia',
    description: 'Portal Data Sekolah Indonesia adalah website yang membantu para pengguna untuk mencari data sekolah indonesia dengan mudah.',
    fullDescription: 'Portal Data Sekolah Indonesia adalah website yang membantu para pengguna untuk mencari data sekolah indonesia dengan mudah. Website ini menyediakan berbagai fitur yang membantu para pengguna untuk mencari data sekolah indonesia dengan mudah cepat efisien.',
    image: '/portofolio/sekolah.png',
    category: ['API'],
    tags: ['API', 'Data Visualization', 'Dashboard'],
    featured: true,
    date: '2026-03-01',
    client: 'Personal',
    technologies: ['React', 'TypeScript', 'Node.js', 'Tailwind CSS'],
    projectUrl: 'https://pdsi.vercel.app/',
    challenge: 'Membuat API yang dapat menangani data besar dengan performa yang optimal.',
    solution: 'Menggunakan Rest API resmi dari data sekolah indonesia untuk visualisasi, implementasi ke sistem.',
    results: [
      'Dapat menampilkan data sekolah indonesia dengan mudah.',
    ]
  },
